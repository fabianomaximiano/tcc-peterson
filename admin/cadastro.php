          ...
          <form action="envio.php" method="POST">
              ...
              <div class="formbold-form-step-1 active">
                <div class="formbold-input-flex">
                  <div>
                      <label for="nome" class="formbold-form-label"> First name </label>
                      <input type="text" name="nome" placeholder="Nome Completo" id="nome" class="formbold-form-input" />
                  </div>
                  <div>
                      <label for="sobrenome" class="formbold-form-label"> Last name </label>
                      <input  type="text" name="sobrenome" placeholder="Dolee" id="sobrenome" class="formbold-form-input" />
                  </div>
                </div>
